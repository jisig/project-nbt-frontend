...
//         contentPadding: edgeInsets ?? const EdgeInsets.symmetric(horizontal: 16, vertical: 18),
//         labelText: labelText,
...
//             ? GoogleFonts.k2d(color: theme.tertiary)
//             : null,
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        border: border ??
            buildBorder(Colors.transparent),

        enabledBorder: enabledBorder ??
            buildBorder(Colors.transparent),

        focusedBorder: focusedBorder ??
            buildBorder(colors.primary, width: 2),

        errorBorder:
        buildBorder(colors.error, width: 1.5),

        focusedErrorBorder:
        buildBorder(colors.error, width: 2),
